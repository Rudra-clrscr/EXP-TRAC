...
export const dashboardStyles = {
  ...
  // Header styles
  headerContainer: "bg-gradient-to-r from-primary-500/10 to-primary-500/10 backdrop-blur-lg rounded-3xl p-6 mb-8 shadow-lg border border-white/30",
  headerContent: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8",
  headerTitle: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent",
  headerSubtitle: "text-gray-600 mt-2",
  
  // Button styles
  addButton: "flex items-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-5 py-3 rounded-xl transition-all shadow hover:shadow-md font-medium",
  
  // Time frame selector styles
  timeFrameContainer: "flex justify-end mt-4",
  timeFrameWrapper: "flex gap-0 bg-surface p-1 -mx-5 rounded-xl border border-gray-200 dark:border-white/5",
  ...
  balanceBadge: "bg-primary-100 text-teal-800 px-2 py-1 rounded-lg text-xs",
  ...
  pieChartContainer: "hidden md:block bg-surface lg:-mx-5.5 md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 relative overflow-hidden mb-8",
  pieChartHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",
  pieChartTitle: "text-xl lg:pt-3 xl:pl-3 font-bold text-foreground mb-5 flex items-center gap-3",
  ...
  listContainer: "bg-surface rounded-2xl lg:p-5 md:p-6 -mx-8 md:-mx-3 shadow-sm border border-gray-100 dark:border-white/5",
  listHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",
  listTitle: "text-xl font-bold text-foreground md:mt-3 mt-3 flex items-center gap-3",
  ...
  transactionDescription: "font-medium text-foreground",
  ...
  viewAllContainer: "pt-4 border-t border-gray-100 dark:border-white/5",
  viewAllButton: "w-full flex items-center justify-center gap-2 py-3 text-primary-600 font-medium hover:bg-teal-50 dark:hover:bg-primary-500/10 rounded-xl transition-colors",
  
  // Icon container styles
  iconContainer: (color) => `p-2 ${color} rounded-lg`,
  
  // Specific icon colors
  walletIconContainer: "p-2 bg-primary-100 rounded-lg",
...
export const trendStyles = {
  ...
  positiveRate: "bg-primary-100 text-primary-700",
...
export const incomeStyles = {
  ...
  headerContainer: "bg-surface rounded-lg md:rounded-xl p-4 -mx-7 lg:-mx-7 overflow-x-hidden md:p-6 mb-6 md:mb-8 shadow",
  header: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 mb-4 md:mb-6",
  headerTitle: "text-xl md:text-2xl lg:text-3xl font-bold text-foreground",
  headerSubtitle: "text-gray-600 mt-1 text-sm md:text-base",
  addButton: "flex items-center gap-2 bg-gradient-to-r from-green-600 to-primary-600 hover:from-green-700 hover:to-emerald-700 text-white px-3 py-2 md:px-4 md:py-3 rounded-lg md:rounded-xl transition-all shadow-md hover:shadow-lg font-medium text-sm md:text-base",
  
  // Summary Cards
  summaryGrid: "grid grid-cols-1 -mx-4 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5",
  
  // Chart
  chartContainer: "hidden md:block -mx-7 bg-surface rounded-xl p-6 shadow-sm border border-gray-100 dark:border-white/5",
  chartTitle: "text-lg md:text-xl font-bold text-foreground mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  
  // Transaction List
  listContainer: "bg-surface rounded-xl -mx-7 md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 dark:border-white/5 relative overflow-hidden",
  sectionTitle: "text-lg md:text-xl font-bold text-foreground mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  
  // Filter Section
  filterContainer: "flex flex-col sm:flex-row gap-2 md:gap-3 w-full sm:w-auto",
  filterSelect: "appearance-none bg-surface border border-gray-300 dark:border-white/10 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent w-full",
  exportButton: "flex items-center justify-center gap-1 bg-surface border border-gray-300 dark:border-white/10 hover:bg-background text-gray-700 px-3 py-2 rounded-lg transition-all text-sm hover:shadow-md w-full sm:w-auto",
  
  // Transaction Items
  transactionList: "space-y-3 -mx-3 lg:-mx-0 md:-mx-0",
  viewAllButton: "mt-4 w-full text-center py-3 text-green-600 font-medium hover:bg-green-50 dark:hover:bg-emerald-500/10 rounded-xl transition-colors flex items-center justify-center gap-2",
  ...
  emptyStateButton: "mt-3 md:mt-4 flex items-center gap-2 bg-gradient-to-r from-green-600 to-primary-600 hover:from-green-700 hover:to-emerald-700 text-white px-3 py-2 md:px-4 md:py-2.5 rounded-lg md:rounded-xl transition-all shadow-md hover:shadow-lg mx-auto text-sm md:text-base",
...
export const expensePageStyles = {
  ...
  // Header card
  headerCard: "bg-surface rounded-xl p-4  lg:-mx-0 -mx-3.5  overflow-x-hidden mb-8 shadow",
  headerContainer: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 mb-4 md:mb-6",
  headerTitle: "text-2xl md:text-3xl font-bold text-foreground",
  ...
  // Chart container
  chartContainer: "hidden md:block bg-surface rounded-xl p-4 -mx-7 lg:-mx-0 shadow-sm border border-gray-100 dark:border-white/5",
  chartHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-5",
  chartTitle: "text-xl font-bold text-foreground mb-5 flex items-center gap-3",
  exportButton: "flex items-center gap-1 bg-surface border border-gray-300 dark:border-white/10 hover:bg-background text-gray-700 px-4 py-2 rounded-lg transition-all text-sm hover:shadow-md",
  chart: "h-80",
  
  // Transactions container
  transactionsContainer: "bg-surface rounded-2xl p-5 -mx-4 lg:-mx-0 md:-mx-5 shadow-sm border border-gray-100 dark:border-white/5 relative overflow-hidden",
  transactionsHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 mb-4 md:mb-5",
  transactionsTitle: "text-lg md:text-xl font-bold text-foreground mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  filterSelect: "appearance-none bg-surface border border-gray-300 dark:border-white/10 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent w-full",
  
  // Transaction items
  transactionsList: "space-y-3 -mx-2 lg:-mx-0 md:-mx-0",
  viewAllButton: "mt-4 w-full text-center py-3 text-orange-600 font-medium hover:bg-amber-50 dark:hover:bg-orange-500/10 rounded-xl transition-colors flex items-center justify-center gap-2",
  emptyState: "text-center py-8",
  ...
  chartExportButton: "flex items-center gap-1 bg-surface border border-gray-300 hover:bg-background text-gray-700 px-4 py-2 rounded-lg transition-all text-sm hover:shadow-md",
...
export const profileStyles = {
  ...
  mainContainer: "bg-surface -mx-7 rounded-2xl shadow-sm overflow-hidden",
  
  // Header styles
  header: "bg-gradient-to-r from-primary-500 to-primary-600 p-8 text-center",
  avatar: "w-24 h-24 mx-auto rounded-full bg-surface/20 flex items-center justify-center mb-4",
  userName: "text-2xl font-bold text-white",
  userEmail: "text-primary-100 mt-2",
  ...
  // Card styles
  card: "bg-background rounded-xl p-6",
  cardTitle: "text-xl font-semibold pb-3 text-foreground flex items-center",
  icon: "w-5 h-5 mr-2 text-primary-600",
  
  // Form styles
  label: "text-sm text-gray-500  block mb-1",
  input: "w-full px-4 py-2 bg-surface border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-300 focus:border-primary-500",
  inputWithError: "w-full px-4 py-2 bg-background border rounded-lg focus:ring-2 focus:ring-teal-300 focus:border-primary-500",
  
  // Button styles
  buttonPrimary: "flex-1 bg-gradient-to-r from-primary-500 to-primary-600 text-white py-2.5 rounded-xl font-medium shadow-md",
  buttonSecondary: "flex-1 py-2.5 border border-gray-300 text-gray-700 rounded-xl font-medium hover:bg-gray-100",
  editButton: "text-primary-600 hover:text-primary-700 font-medium text-sm",
  changeButton: "text-primary-600 hover:text-primary-700 font-medium lg:text-sm",
  
  // Security item
  securityItem: "flex items-center justify-between p-4 bg-surface rounded-xl border border-gray-200",
  securityText: "font-medium lg:text-sm text-gray-400",
  
  // Modal styles
  modalContent: "bg-surface rounded-2xl p-6 lg:px-28 w-full max-w-md",
  modalHeader: "flex justify-between lg:whitespace-nowrap lg:space-x-20 mb-6",
  modalTitle: "text-xl font-bold lg:pl-10 text-foreground",
...
export const modalStyles = {
  ...
  modalContainer: "bg-surface rounded-2xl p-6 max-w-md w-full shadow-2xl",
  
  // Header
  modalHeader: "flex justify-between items-center mb-4",
  modalTitle: "text-xl font-bold text-foreground",
  closeButton: "text-gray-500 hover:text-foreground",
  ...
  colorClasses: {
    teal: {
      ...
      typeButtonSelected: "bg-primary-500",
    },
    orange: {
...
export const loginStyles = {
  ...
  // Card container
  cardContainer: "w-full max-w-md bg-surface rounded-2xl shadow-xl overflow-hidden",
  
  // Header styles
  header: "bg-gradient-to-r from-primary-500 to-primary-600 p-6 text-center",
  avatar: "w-20 h-20 mx-auto rounded-full bg-surface/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-primary-100 mt-2",
  ...
  input: "w-full pl-10 pr-4 py-3 bg-background border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-primary-500",
  passwordInput: "w-full pl-10 pr-10 py-3 bg-background border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-primary-500",
  passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  ...
  // Button
  button: "w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center",
  buttonDisabled: "opacity-80 cursor-not-allowed",
  
  // Sign up link
  signUpContainer: "mt-8 text-center",
  signUpText: "text-gray-600",
  signUpLink: "font-medium text-primary-600 hover:underline",
...
export const navbarStyles = {
  ...
  header: "sticky top-0 z-50 bg-surface border-b border-gray-100 shadow-sm",
  ...
  // Text styles
  logoText: "lg:text-3xl md:text-3xl text-2xl text-foreground font-[550] lobster-regular",
  
  // User profile styles
  userContainer: "relative",
  userButton: "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-background transition-colors",
  userAvatar: "w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-primary-600 to-primary-500 text-white font-bold text-lg",
  ...
  dropdownMenu: "absolute top-14 right-0 w-56 bg-surface rounded-xl shadow-lg border border-gray-100 z-50",
  dropdownHeader: "px-4 py-3 border-b border-gray-100",
  dropdownAvatar: "w-10 h-10 rounded-full bg-gradient-to-br from-primary-600 to-primary-500 flex items-center justify-center text-white font-bold text-lg",
  dropdownName: "text-sm text-foreground ",
  dropdownEmail: "text-xs text-gray-500",
  
  // Menu items
  menuItemContainer: "p-1.5",
  menuItem: "w-full px-4 py-3 text-left hover:bg-background text-sm text-gray-700 flex items-center gap-3 rounded-lg",
...
export const signupStyles = {
  ...
  header: "bg-gradient-to-r from-primary-500 to-primary-600 p-6 text-center relative",
  avatar: "w-20 h-20 mx-auto rounded-full bg-surface/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-primary-100 mt-2",
  backButton: "absolute top-4 left-4 p-2 text-white rounded-full hover:bg-surface/10 transition-colors",
  ...
  inputContainer: "relative",
  inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400",
  input: "w-full pl-10 pr-4 py-3 bg-background border rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-primary-500",
  passwordInput: "w-full pl-10 pr-10 py-3 bg-background border rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-primary-500",
  passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  ...
  signInLink: "font-medium text-primary-600 hover:underline",
...
export const transactionItemStyles = {
  ...
  container: (isEditing, classes) => 
    `flex flex-col md:flex-row items-stretch justify-between gap-3 p-4 rounded-xl border border-gray-100 mb-3 last:mb-0 ${isEditing ? classes.bg : "hover:bg-background"}`,
  ...
  description: "font-medium text-foreground truncate",
  details: "text-xs text-gray-500 mt-1 truncate",
  
  // Input styles
  input: (hasError, classes) => 
    `w-full bg-surface rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${hasError ? "border-red-500 ring-red-500" : `${classes.border} ${classes.ring}`}`,
  amountInput: (hasError, classes) => 
    `w-full max-w-[120px] bg-surface rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${hasError ? "border-red-500 ring-red-500" : `${classes.border} ${classes.ring}`}`,
...
export const sidebarStyles = {
  ...
  sidebarInner: {
    base: "bg-surface border-r  border-gray-200 shadow-md h-full flex flex-col"
  },
  ...
  userInitials: {
    base: "w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-400 to-primary-500 flex items-center justify-center text-white font-bold text-xl"
  },
  ...
  menuItem: {
    ...
    active: "text-primary-600 bg-primary-500/10 dark:bg-primary-500/10",
    inactive: "text-gray-600 hover:text-primary-700 hover:bg-background dark:hover:bg-white/5",
  ...
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-12 z-20 w-6 h-6 bg-surface border border-gray-300 dark:border-white/10 rounded-full flex items-center justify-center text-gray-500 hover:text-primary-600 hover:border-teal-400 hover:bg-primary-500/10 transition-all"
  },
  
  // Footer section
  footerContainer: {
    base: "border-t border-gray-100 dark:border-white/5 p-4",
    collapsed: "px-3",
    expanded: "px-6"
  },
  
  footerLink: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 hover:text-primary-700 hover:bg-background",
  ...
  mobileSidebar: {
    base: "absolute left-0 top-0 bottom-0 w-4/5 max-w-sm bg-surface shadow-2xl rounded-r-2xl overflow-hidden"
  },
  ...
  mobileMenuItem: {
    ...
    active: "text-primary-600 bg-primary-500/10 dark:bg-primary-500/10",
    inactive: "text-gray-600 hover:bg-background dark:hover:bg-white/5"
  },
  
  mobileFooter: "border-t border-gray-100 p-6",
  mobileFooterLink: "flex items-center gap-4 py-2 font-medium text-gray-600 hover:text-primary-700",
  mobileLogoutButton: "flex items-center gap-4 py-2 font-medium text-gray-600 hover:text-red-600 w-full",
  
  // Mobile menu button
  mobileMenuButton: "lg:hidden fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 text-white rounded-full flex items-center justify-center shadow-xl"
};
...
export const styles = {
  ...
  statCards: {
    ...
    card: "bg-surface p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5",
    cardHeader: "flex justify-between items-start",
    cardTitle: "text-sm text-gray-600",
    cardValue: "text-2xl font-bold text-foreground mt-1",
  ...
  // Card Styles
  cards: {
    base: "bg-surface rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-white/5",
    header: "flex justify-between items-center mb-6",
    title: "text-xl font-bold text-foreground flex items-center gap-3",
    titleIcon: "w-6 h-6",
  },
  ...
  transactions: {
    ...
    cardTitle: "text-md md:text-xl lg:text-xl xl:text-xl font-bold text-foreground flex items-center gap-3",
    refreshButton: "p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5 transition-colors",
    refreshIcon: (loading) => `w-5 h-5 text-gray-500 ${loading ? 'animate-spin' : ''}`,
    dataStackingInfo: "flex items-center gap-2 text-xs text-gray-500 mb-4 bg-blue-50 dark:bg-blue-500/5 dark:text-blue-400 dark:border-blue-500/10 border border-transparent p-2 rounded-lg",
    dataStackingIcon: "w-4 h-4 text-blue-500",
    listContainer: "space-y-4 max-h-[500px] -mx-5 overflow-y-auto pr-2",
    transactionItem: "flex items-center lg:flex-col xl:flex-row md:flex-row justify-between p-1 -mx-0 lg:p-4 md:p-4 hover:bg-background rounded-xl transition-all duration-300 border border-gray-100 dark:border-white/5",
    iconWrapper: (type) => type === 'income' ? 'bg-primary-100 text-primary-600' : 'bg-orange-100 text-orange-600',
    icon: "w-4 h-4",
    details: "min-w-0",
    description: "font-medium text-foreground truncate max-w-[120px]",
    meta: "text-xs text-gray-500 mt-1",
    amount: (type) => `font-semibold ${type === 'income' ? 'text-primary-600' : 'text-orange-600'}`,
    emptyState: "text-center py-8",
  ...
  categories: {
    title: "text-lg md:text-xl lg:text-xl xl:text-xl font-bold text-foreground mb-6 flex items-center gap-3",
    titleIcon: "w-6 h-6 text-primary-500",
    list: "space-y-4",
    categoryItem: "flex items-center md:text-lg lg:text-sm xl:text-lg justify-between",
    categoryIconContainer: "bg-gray-100 dark:bg-white/5 p-2 rounded-lg",
    categoryIcon: "w-4 h-4 text-gray-600",
    categoryName: "font-medium text-gray-700",
    categoryAmount: "font-semibold text-foreground",
    summaryContainer: "mt-6 pt-6 border-t border-gray-100 dark:border-white/5",
    summaryGrid: "grid grid-cols-2 gap-4",
    summaryIncomeCard: "bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-500/5 dark:to-cyan-500/5 rounded-xl p-4 border border-transparent dark:border-white/5",
    summaryExpenseCard: "bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-500/5 dark:to-amber-500/5 rounded-xl p-4 border border-transparent dark:border-white/5",
    summaryTitle: "text-sm text-gray-600",
    summaryValue: "text-sm font-bold text-foreground",
  },

  // Color Helpers
  colors: {
    transaction: {
      text: (type) => type === 'income' ? 'text-primary-600' : 'text-orange-600',
      bg: (type) => type === 'income' ? 'bg-primary-100 text-primary-600' : 'bg-orange-100 text-orange-600',
    },
